...
(
    ...
    cp busybear-linux/build/busybox-${BUSYBOX_VERSION}/busybox mnt/bin/
    cp busybear-linux/build/dropbear-${DROPBEAR_VERSION}/dropbear mnt/sbin/
    ...
    # final configuration
    rsync -a busybear-linux/etc/ mnt/etc/
    ...
    cp busybear-linux/bin/ldd mnt/bin/ldd
